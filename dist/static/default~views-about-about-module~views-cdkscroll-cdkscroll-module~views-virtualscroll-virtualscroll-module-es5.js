...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-about-about-module~views-cdkscroll-cdkscroll-module~views-virtualscroll-virtualscroll-module"], {
  /***/
  ...
  function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        key: "getScrollableList",
        value: function getScrollableList(list, size) {
          var chunks = [];
        ...
        value: function isMobile() {
          ...
          return /\b(iPhone|iP[ao]d)/.test(userAgent) || /\b(iP[ao]d)/.test(userAgent) || /Android/i.test(userAgent) || /Mobile/i.test(userAgent) || window.innerWidth <= 768;
        }
      }, {
        key: "getIpsum",
        value: function getIpsum() {
          var url = '//www.mocky.io/v2/5e4394cf310000383f3affcb';
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (x) {
            return x.text;
          }));
        }
      }]);
  ...
  function srcAppServicesLinkServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LinkService = /*#__PURE__*/function () {
      ...
      _createClass(LinkService, [{
        ...
        value: function updateTag(tag) {
          ...
          var linkElement = this.document.head.querySelector(selector) || this.document.head.appendChild(this.document.createElement('link'));
        ...
        */
        ...
        value: function _parseSelector(tag) {
          ...
          return "link[".concat(attr, "=\"").concat(tag[attr], "\"]");
        }
      }]);
    ...
    LinkService.ɵfac = function LinkService_Factory(t) {
      return new (t || LinkService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["RendererFactory2"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"]));
    };
  ...
  function srcAppServicesUtilityServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _link_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./link.service */
    "./src/app/services/link.service.ts");
    /* harmony import */
    ...
    var UtilityService = /*#__PURE__*/function () {
      function UtilityService(meta, title, link, http) {
      ...
      _createClass(UtilityService, [{
        key: "setHeaderTagsByPath",
        value: function setHeaderTagsByPath() {
          this.setHeaderTags(location.pathname.replace('/', ''));
        }
      }, {
        key: "test",
        value: function test() {
          var url = 'www.mocky.io/v2/5e6738d13100007b0023071d';
          return this.http.get(url).subscribe(function (x) {
            console.log(x);
          });
        }
      }, {
        key: "setHeaderTags",
        value: function setHeaderTags(keyword) {
          var _this = this;

          this.title.setTitle(this.buildTitle(keyword));
          this.buildMetas(keyword).map(function (meta) {
            _this.meta.updateTag(meta);
          });
          this.buildCopyRight().subscribe(function (copyright) {
            return _this.meta.updateTag(copyright);
          });
          this.buildIpMeta().subscribe(function (ipAddress) {
            return _this.meta.updateTag(ipAddress);
          });
          this.link.updateTag(this.buildCanonical(keyword));
        }
      }, {
        key: "buildTitle",
        value: function buildTitle(path) {
          return "".concat(path, " demo");
        }
      }, {
        key: "buildCanonical",
        value: function buildCanonical(path) {
          return {
            rel: 'canonical',
            href: "".concat(location.origin, "/").concat(path)
          };
        }
      }, {
        key: "buildMetas",
        value: function buildMetas(path) {
          return [{
            name: 'description',
            content: "demo for ".concat(path)
          }, {
            httpEquiv: 'ROBOTS',
            name: 'ROBOTS',
        ...
        key: "buildIpMeta",
        value: function buildIpMeta() {
          var url = '//api.ipify.org?format=json'; // const url = 'https://jsonip.com/';
        ...
        value: function buildCopyRight() {
          var url = '//www.mocky.io/v2/5e673944310000a700230721';
          return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (data) {
            return {
              name: 'copyright',
    ...
    UtilityService.ɵfac = function UtilityService_Factory(t) {
      return new (t || UtilityService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["Meta"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["Title"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_link_service__WEBPACK_IMPORTED_MODULE_3__["LinkService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]));
    };
...
//# sourceMappingURL=default~views-about-about-module~views-cdkscroll-cdkscroll-module~views-virtualscroll-virtualscroll-module-es5.js.map