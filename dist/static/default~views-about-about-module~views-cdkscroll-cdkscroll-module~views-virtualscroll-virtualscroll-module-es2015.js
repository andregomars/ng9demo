...
class DataService {
    ...
    getIpsum() {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((x) => x.text));
    }
}
...
LinkService.ɵfac = function LinkService_Factory(t) { return new (t || LinkService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["RendererFactory2"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"])); };
...
/* harmony import */ var _link_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./link.service */ "./src/app/services/link.service.ts");
...
class UtilityService {
    constructor(meta, title, link, http) {
        this.meta = meta;
        this.title = title;
        this.link = link;
        this.http = http;
    ...
    test() {
        ...
        return this.http.get(url).subscribe(x => { console.log(x); });
    }
    setHeaderTags(keyword) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UtilityService, [{
    ...
    }], function () { return [{ type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["Meta"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["Title"] }, { type: _link_service__WEBPACK_IMPORTED_MODULE_3__["LinkService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~views-about-about-module~views-cdkscroll-cdkscroll-module~views-virtualscroll-virtualscroll-module-es2015.js.map